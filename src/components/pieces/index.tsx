...
const KingComponent = ({ color }: PieceProp) => {
  return (
...
const QueenComponent = ({ color }: PieceProp) => {
  return (
...
const RookComponent = ({ color }: PieceProp) => {
  return (
...
const BishopComponent = ({ color }: PieceProp) => {
  return (
...
const PawnComponent = ({ color }: PieceProp) => {
  return (
    <SVGComponent color={color} viewbox="0 0 320 512">
...
const KnightComponent = ({ color }: PieceProp) => {
  return (
    <SVGComponent
      xmlns="http://www.w3.org/2000/svg"
      viewbox="0 0 448 512"
